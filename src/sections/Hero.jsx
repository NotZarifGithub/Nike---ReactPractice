...
const Hero = () => {
  ...
  return (
    <section 
      id='home'
      className='flex flex-col items-center w-full min-h-screen gap-10 xl:flex-row max-container'>
      <div className='relative flex flex-col items-start justify-center w-full xl:w-2/5 max-xl:padding-x pt-28'>
        ...
        <div className='flex flex-row flex-wrap items-start justify-start w-full gap-16 mt-20'> 
